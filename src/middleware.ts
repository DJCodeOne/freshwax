...
export const onRequest = defineMiddleware(async ({ locals, request }, next) => {
  ...
  if (isHtml) {
    ...
    // 'unsafe-inline' has been removed — all scripts must have a valid nonce.
