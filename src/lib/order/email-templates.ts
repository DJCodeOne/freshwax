// src/lib/order/email-templates.ts
// Email HTML template builders for order notifications
...
export function buildStockistFulfillmentEmail(orderId: string, orderNumber: string, order: Record<string, unknown>, vinylItems: CartItem[]): string {
