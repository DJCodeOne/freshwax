// Which submission produced each live Hangry release? Compares against the
// leftover R2 submission folder shown in admin "Pending Submissions".
...
(async () => {
  ...
  for (const id of ['hangry_records_FW-1780739181417', 'hangry_records_FW-1780824861889']) {
    ...
    console.log(JSON.stringify({
      ...
      submissionId: f.submissionId?.stringValue,
      status: f.status?.stringValue,
      processedAt: f.processedAt?.stringValue,
