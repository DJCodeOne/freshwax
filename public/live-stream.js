...
function showLiveStream(streamData) {
  ...
  try {
    ...
    setStreamTicker(streamData.isRelay ? ((streamData.relaySource && streamData.relaySource.stationName) || streamData.title || 'Relayed stream') : ((streamData.title && streamData.title !== 'Live Session') ? streamData.title : 'Live and Direct on freshwax.co.uk'));
